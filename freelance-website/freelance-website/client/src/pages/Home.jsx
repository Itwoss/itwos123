  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">Welcome to My Freelance Portfolio</h1>
        <p className="text-xl text-gray-600">I create beautiful, functional websites and applications</p>
      </div>
